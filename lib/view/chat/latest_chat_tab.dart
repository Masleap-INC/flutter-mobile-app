...
class LatestChatTab extends StatelessWidget {
  final UserModel localUser;

  const LatestChatTab({Key? key, required this.localUser}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return PaginateFirestore(
      ...
      query: FirestoreQueries.latestChatQuery(localUser.id!),
