...
import 'package:inkistry/view/widgets/user/artist_cards/search_artist_card_widget.dart';
...
class FollowingArtistCardViewModel extends GetxController {
  final RxString artistId;
  final Rxn<UserModel> artist;

  FollowingArtistCardViewModel({String? artistId, UserModel? artist})
  ...
  followThisArtist() async {
    ...
    Get.find<SearchArtistCardViewModel>(tag: artist.value!.id!)
        .isFollowed(true);
...
class FollowingArtistCardWidget extends StatelessWidget {
  final FollowingArtistCardViewModel controller;
  final VoidCallback? onTap;

  const FollowingArtistCardWidget(
